          ...
          <div className='w-full flex flex-col justify-between sm:w-1/2 sm:h-full'>
            ...
            <div className='w-full h-full flex flex-col justify-center items-center'>
              ...
              >
                ...
                <h1 className='text-lg italic md:text-xl text-white mb-6 sm:-ml-24'>
                ...
                <motion.button
                  ...
                  className='text-md text-white font-bold border border-solid border-white mx-auto w-4/5 sm:w-44 rounded-full py-3 bg-[#49B5C0] hover:bg-[#3c97a1] sm:mt-5 sm:ml-0'
                >
                  <a href='S'>APPLY</a>
                </motion.button>
              </motion.div>
