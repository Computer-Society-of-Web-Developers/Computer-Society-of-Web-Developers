...
export const NEXT_PUBLIC_API_KEY: string = process.env.NEXT_PUBLIC_API_KEY as string;

export const QUERY_TABLE: string = "queries";
export const ENTRY_BUCKET: string = "resume";
export const ENTRY_TABLE: string = "entries";
